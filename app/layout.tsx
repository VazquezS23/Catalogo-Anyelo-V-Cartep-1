...
export const metadata: Metadata = {
  metadataBase: new URL("https://catalogo-anyelo-v-cartep-1.vercel.app"),
  ...
  openGraph: {
    ...
    description: CONFIG.marca.descripcion,
    type: "website",
    images: [{ url: "/productos/villa-diana-fachada.jpg", width: 1200, height: 1200, alt: CONFIG.marca.negocio }],
  },
};
