...
export interface Producto {
  ...
  imagen?: string;
  /**
   * Galería de fotos para la ficha (opcional). Si la pones, la ficha muestra
   * una foto grande con miniaturas para cambiarla. La primera suele ser la
   * misma que `imagen`. Ideal para propiedades con varias vistas.
   */
  galeria?: string[];
  /**
